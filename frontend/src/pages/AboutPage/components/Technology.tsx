          ...
          <Grid container spacing={2} alignItems="center">
            <Grid item xs={4}>
              ...
              >
                ...
                <Typography variant="h6">No Compatibility Issues</Typography>
            ...
            <Grid item xs={4}>
              ...
              >
                ...
                <Typography variant="h6">Best Possible Performance</Typography>
                <Typography variant="body1" component="p">
            ...
            <Grid item xs={4}>
              ...
              >
                ...
                <Typography variant="h6">Fully Customizeable</Typography>
                <Typography variant="body1" component="p">
            ...
            <Grid item xs={4}>
              ...
              >
                ...
                <Typography variant="h6">Friendly Interface</Typography>
                <Typography variant="body1" component="p">
            ...
            <Grid item xs={4}>
              ...
              >
                ...
                <Typography variant="h6">Fast and Reliable</Typography>
                <Typography variant="body1" component="p">
