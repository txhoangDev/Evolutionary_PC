...
const Build: React.FC = () => {
    ...
    const handleCpuBudgetChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const handleGpuBudgetChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const handleRamBudgetChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        <Grid container spacing={2} direction="column" alignItems="center">
            ...
            <Grid item xs={12} md={6}>
                <FormControl>
                    ...
                    >
                        <FormControlLabel value="GeForce" control={<Radio />} label="NVIDIA" />
                        <FormControlLabel value="AMD" control={<Radio />} label="AMD" />
                        <FormControlLabel value="None" control={<Radio />} label="No Preference" />
                    </RadioGroup>
                </FormControl>
                ...
                {allStepsCompleted() ? (
                    ...
                    <React.Fragment>
                        ...
                        <Box sx={{ display: 'flex', flexDirection: 'row', pt: 2 }}>
                            ...
                            <Box sx={{ flex: '1 1 auto' }} />
                            <Button disabled={validateInput()} onClick={handleNext} sx={{ mr: 1 }}>
                                Next
                            </Button>
                        </Box>
                    </React.Fragment>
